    ...
    <main>
      ...
      <section className="producto">
        <div className="producto-imagen">
          <img src={anticuchoverdura} alt="Anticucho Verdura" />
          <div className="miniaturas">
            <img src={anticuchoverdura2|| anticuchoverdura} alt="Vista 1 del anticucho verdura" />
            <img src={anticuchoverdura3 || anticuchoverdura} alt="Vista 2 del anticucho verdura" />
            <img src={anticuchoverdura4 || anticuchoverdura} alt="Vista 3 del anticucho verdura" />
          </div>
        </div>
