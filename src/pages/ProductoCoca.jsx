      ...
      <section className="producto">
        <div className="producto-imagen">
          ...
          <div className="miniaturas">
            <img src={cocaCola2|| cocaCola} alt="Vista 1 de Coca Cola" />
            <img src={cocaCola3 || cocaCola} alt="Vista 2 de Coca Cola" />
            <img src={cocaCola4 || cocaCola} alt="Vista 3 de Coca Cola" />
          </div>
        </div>
        ...
        <div className="producto-info">
          ...
          <p className="descripcion">
            Delicioso y refrescante bebida Coca Cola bien fría.
          </p>
