...
function Registro() {
    ...
    const handleSubmit = (e) => {
        ...
        if (email.endsWith('@duoc.cl')) { descuentos.push("Tortas gratis en tu cumpleaños por ser estudiante Duoc"); }
        ...
        } else { const edad = calcularEdad(fechaNac); if (edad >= 50) { descuentos.push("50% de descuento por ser mayor de 50 años"); } }
        if (!direccion || direccion.length > 300) {
            setTipoMensaje("danger"); setMensaje("Dirección requerida (máx. 300 caracteres)"); return;
        }
        if (!region || !comuna) {
            setTipoMensaje("danger"); setMensaje("Debe seleccionar una Región y Comuna"); return;
        }
        ...
        if (codigo === "FELICES8") { descuentos.push("10% de descuento por código FELICES8"); }
        ...
        <main className="contenedor">
            ...
            <form className="formulario" id="formularioRegistro" onSubmit={handleSubmit} noValidate>
                <div className="row g-3"> 
                    ...
                    <div className="col-12"><p className="muted">Regístrate con el código FELICES8 y tendrás 10% de descuento!</p></div>
                </div>
            </form>
        </main>
    );
